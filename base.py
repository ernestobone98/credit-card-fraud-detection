...
# -------------------------------------- def create_phones() -> Fait par Ernesto -------------------------------------- #
...
# -------------------------------------- Info creation:  -> Fait par Benjamin, Marco  -------------------------------------- #
...
def random_info_creation(s, n): # s = man or woman / n = id
    ...
    return [name, f_name, age, job, city, number]
...
if __name__ == '__main__':
    f_out = "Informations_clients.csv"
    m_client = 3300000 # number of men client
    w_client = 3300000 # number of women client
    client_list = []
    ...
    #     a_montrer.new_client(client_list[i])
    # a_montrer.close()
    a_montrer.check_doublons()
